...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="font-end, back-end, web devoloper, baaliDev">
        ...
        <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-4857363969309688"
    ...
    <body> 
        ...
        <header>
            ...
            <div data-aos="fade-right" data-aos-duration="1300" class="logo">
                <a href="index.html" title="home">baaliDev</a>
                <a href="index.html" title="home">baaliDev</a>
            </div>
            <nav >
                <!--menu-btn  -->
        ...
        <main>
            <div id="home">
                <div data-aos="fade-right" data-aos-duration="1300" class="content-home">
                   <h2 class=" fs-3">welcome i'm Abdessamad</h2>
                    <h1 class=" display-4 ">Front-end developer</h1>
        ...
        <section id="about" >
            <div data-aos="fade-right" data-aos-duration="1000" class="row">
                <div  class="col-lg-9 col-md-12">
                    <h2 >about me</h2>
                    <p> 
                        Hi, I'm Abdessamad Baali.I'm a front end developer  with over 2 years of experience. who  wants to put my skills to good use by assisting others. i strive to provide 100% customer care to all of my customers.. For an in-depth insight into my skills and qualification I invite you to check out my 
                        <a href="domument/Resume.pdf" target="_blank"> my Resume</a>.
                    </p>

                    <!-- this part is for read more -->
                    <div class="collapse container-fluid mt-3" id="readMore">
                ...
                <p>  
                    <a id="read-more-btn" onclick="readMoreScript()" 
                        class="btn btn-warning" 
                        data-bs-toggle="collapse" href="#readMore">
                        Read More...
                    </a>
                </p>
            </div> 
        ...
        <section id='skills' class="container-fluid ">
            ...
            <p class="desc">
                ...
                with high experience and knowled
            </p>
            <p class="desc">
            ...
            <div class="row row-cols-md-2 justify-content-center ">
                ...
                <div data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <div class="progress">
                        <div class="progress-bar  progress-bar-animated bg-dark" style="width: 95%">95%</div>
                    </div>
                    <p class="desc">
                ...
                <div data-aos="fade-down" data-aos-duration="1000">
                    <i class="fab fa-css3 fs-3"></i>  <span class="fs-2">Css3</span>
                    <div class="progress">
                        <div class="progress-bar  progress-bar-animated bg-dark" style="width: 90%">90%</div>
                    </div>
                </div> -->
                <!-- javaScripit -->
                <div data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <div class="progress">
                        <div class="progress-bar  progress-bar-animated bg-dark" style="width: 80%">80%</div>
                    </div>
                    <p class="desc">
                ...
                <div data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <div class="progress">
                        <div class="progress-bar  progress-bar-animated bg-dark" style="width: 60%">60%</div>
                    </div>
                    <p class="desc">
                ...
                <div data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <div class="progress">
                        <div class="progress-bar  progress-bar-animated bg-dark" style="width: 40%">40%</div>
                    </div>
                </div>
                ...
                <div data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <div class="progress">
                        <div class="progress-bar  progress-bar-animated bg-dark" style="width: 75%">75%</div>
                    </div>
                </div>
            </div>
        ...
        <section id="big-projects" class="container-fuild  p-3 text-center" >
            ...
            <div class="all-project">
                ...
                <div  data-aos="fade-up" data-aos-delay="3000" class="project shadow">       
        ...
        <section id="other">  
            ...
            <div class="container-fluid">
                ...
                row-cols-sm-2 row-cols-md-2 row-cols-xl-3"> 
                    ...
                    <!-- js doc -->
                    <div data-aos="zoom-in-down" data-aos-duration="1500"  class="card shadow ">
                    ...
                    <!-- calutaltore -->
                    <div data-aos="zoom-in" data-aos-duration="3000" class="card shadow " >
                        <div class="container-img">
                    ...
                    <!-- take a random color  -->
                    <div data-aos="zoom-in" data-aos-duration="1500" class="card shadow " >
                        <div class="container-img">
        ...
        <section  id="contact" >
            ...
            <div class="container-fuild container-from-card" > 
                ...
                <div  id="container-form">
                    ...
                    <form id='form-contact' action="form.php" method="post">
                        <label  for="name">User name</label>
                        <input  class="btn   rounded-pill" id="name" type="text" name="user" placeholder="Full Name" required
                        minlength="8"  maxlength="20">
    
                        <label  for="mail">Email</label>
                        <input class="btn rounded-pill" id="mail" type="email" name="mail" placeholder="Email" required>
    
                        <label  for="phone">Phone</label>
                        <input class="btn   rounded-pill" id="phone" type="tel" name="phone" placeholder="phone" required>
    
                        <label  for="msg">Your Message</label>
                        <textarea  class="btn  "id="msg" name="msg" placeholder="Write Your Message Here" required > </textarea>
                        <br>
                        <div class="btn-group ">
        ...
        <footer class="footer text-center ">
            <div class="container">
                ...
                <span class="text-dark" >Front-End Developer, UI Designer</span>
            </div>
        </footer>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-226995514-1">
        </script>
        <script>
